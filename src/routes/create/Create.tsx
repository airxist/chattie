      ...
      <div className='px-5 md:px-32 min-h-screen pt-28 md:flex items-start justify-center overflow-hidden'>
        ...
        <form ref={FormRef} className='md:w-[37rem] flex flex-col space-y-3 md:' onSubmit={handleSubmit}>
          ...
          <div className='flex flex-col items-start space-y-5 md:space-y-0 md:flex-row  md:items-center'>
            <Button text={`${screenSize === 'small' ? 'Invite Your Friends' : 'Proceed to invite'}`} className='primary-btn w-full md:w-3/5' />

            <Button text="Skip" className='secondary-btn w-full md:w-1/5 border border-blue-800' />
